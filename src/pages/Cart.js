    ...
    <div>
      {
        ...
        (<div className='min-h-[80vh] flex flex-col justify-center items-center'>
            <h1 className='text-2xl mb-5'>Your cart is empty !</h1>  
            <div className='flex justify-center'>
              <NavLink to='/' className='bg-green-600 tracking-wider hover:bg-purple-50 hover:border-green-600 hover:border-2 transition-all  hover:text-green-600 text-xl px-10 text-white font-semibold rounded-xl py-3'>SHOP NOW</NavLink>
            </div>
        </div>)
      }
    </div>
